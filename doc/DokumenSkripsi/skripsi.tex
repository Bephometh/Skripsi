...
\newcommand{\abstrakINA}[1]{\vtext{\vabstrakINA}{#1}{}} 
\newcommand{\abstrakENG}[1]{\vtext{\vabstrakENG}{#1}{}} 
...
\tableofcontents \cleardoublepage 							% Daftar isiz
