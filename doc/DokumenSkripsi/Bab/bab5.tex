...
\section{Implementasi Penyesuaian Konfigurasi Aplikasi}
...
\section{Implementasi Meluncrukan apk \textit{Release}}
...
\begin{minipage}{.5\textwidth} 
	\centering  
	\includegraphics[scale=0.15]{spalsh_screen-id.ac.unpar.moodlemobile.jpg}  
	\caption[Halaman \textit{loading} aplikasi] {Halaman \textit{loading} aplikasi} 
	\label{app:loading} 
\end{minipage}
\begin{minipage}{.5\textwidth}
	\centering  
	\includegraphics[scale=0.15]{login_screen-id.ac.unpar.moodlemobile.jpg}  
