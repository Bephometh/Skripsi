...
. \textit{NgModules} dapat dianggap sebagai wadah untuk untuk kode yang didedikasikan untuk domain aplikasi, \textit{workflow}, atau kapabilitas aplikasi yang berseifat erat. \textit{NgModules} akan menyediakan sebuah kompilasi kontex untuk komponen. \cite{angular:architecture:modules}
