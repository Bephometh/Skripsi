...
%=============================================================================
\namanpm{Gabriel Panji Lazuardi}{2016730068}
\tanggal{27}{10}{2020}         %isi bulan dengan angka
\pembimbing{\PAN}{}    
\penguji{}{} 
%=============================================================================
...
%=============================================================================
\judulINA{Aplikasi mobile IDE UNPAR berbasis Moodle App}
\judulENG{Mobile Application for the IDE UNPAR based on Moodle App}
%_____________________________________________________________________________
%=============================================================================
% 								BAGIAN X
%=============================================================================
...
% - langsung mulai setelah '{' awal, jangan mulai menulis di baris bawahnya
%=============================================================================
\abstrakINA{IDE UNPAR adalah \textit{learning management system} yang digunakan oleh UNPAR untuk menjalakan perkuliahan secara daring. IDE UNPAR dibangun dengan menggunakan \textit{Open LMS}, dimana \textit{Open LMS} sendiri menggunakan Moodle untuk pengembangannya. 

Moodle menyediakan sebuah aplikasi yang dapat terhubung dengan situs yang telah dibangun menggunakan menggunakan Moodle pada perangkat bergerak. Aplikasi tersebut juga bersifat \textit{open source} sehingga pengubahan dan pendistibusian ulang setelah aplikasi mengalami perubahan diperbolehkan dengan memenuhi beberapa syarat dari lisensi yang digunakan. Aplikasi tersebut adalah Moodle app.

Moodle app dibangun dengan menggunakan \textit{framework} Ionic. Ionic adalah \textit{framework} pengembangan aplikasi yang menggunakan HTML, CSS, Javascript, Angular, dan Cordova  untuk membuat aplikasi pada \textit{desktop} dan perangkat bergerak. Sehingga aplikasi Mobile IDE UNPAR akan dibangun menggunakan Moodle app.
 }
\abstrakENG{IDE UNPAR is as learning management system that is used by UNPAR to host online lectures. IDE UNPAR was built using Open LMS, where Open LMS itsel uses Moodle for its development.

Moodle provides an application that can connect to a site that was built using Moodle on a mobile device. The app is an open source, so that changes and redistrubution after the app itself undergoes changes is allowed by fulfilling some of the conditions that are listed in the license being used. The app itself is called Moodle app.

Moodle app is built using the Ionic framework. Ionic is a software development kit that uses HTML, CSS, Javascript, Angular, and Corodva to build application on desktop and mobile devices. Thus Mobile IDE UNPAR will be built using Moodle app as it base } 
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\kunciINA{Moodle, IDE UNPAR, pengembangan, fitur, Moodle app, perangkat bergerak }
\kunciENG{Moodle, IDE UNPAR, development, features, Moodle app, mobile devices}
%=============================================================================
...
%=============================================================================
\untuk{
Puji syukur kepada Yang Maha Esa atas memungkinkannya penulis untuk menyelesaikan skripsi dengan judul Aplikasi Mobile IDE UNPAR Berbasis Moodle App. Penulis juga ingin mengucapkan terima kasih kepada pihak-pihak yang memberikan dukungan dan bantuan kepada penulis dalam penulisan skripsi ini. Penulis berterima kasih kepada :

\begin{enumerate}
\item Kedua orang tua penulis, Bapak Supranoto dan Ibu Maarta yang selalu memberikan dukungan.
